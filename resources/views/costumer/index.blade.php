            ...
            <div class="p-4 md:p-5 space-y-4">
                <form action="#" method="post" id="form-create">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="nama" name="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required value="{{ old('nama') }}">
                    </div>
                    <div class="mb-6">
