<div>
    <div class="flex flex-wrap justify-between gap-4 mb-2">
        <div class="flex items-center gap-3">
            ...
            <select wire:model.change="filter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-1">
                <option value="">All Type</option>
                <option value="lunas">Pembayaran : Lunas</option>
                <option value="belum lunas">Pembayaran : Belum Lunas</option>
                <option value="belum bayar">Pembayaran : Belum Bayar</option>
                <option value="proses">Invoice : Proses</option>
                <option value="selesai">Invoice : Selesai</option>
                <option value="batal">Invoice : Batal</option>
            </select>
        </div>
        <div class="sm:w-3/12">
            <input type="search" wire:model.live.debounce.400ms="search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Search invoice, tujuan, pengirim">
        </div>
    </div>
    ...
    <div class="flex items-center gap-3 mt-4">
        ...
        <select name="filter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-1" wire:model.change="perPage">
            <option>10</option>
            <option>50</option>
            <option>100</option>
        </select>
