...
<header class="w-full p-4 border border-gray-200 shadow rounded-lg mb-6">
    <div class="mb-3">
        <h1 class="text-2xl">Buat Invoice Baru</h1>
        <hr>
    </div>
            ...
            <div class="flex justify-between">
                <div class="">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="form-lock" id="form-lock" class="sr-only peer" checked>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 border border-gray-200 rounded-lg shadow">
                ...
                <div class="mb-6">
                    ...
                    <div wire:ignore>
                        <select name="kota-tujuan" id="kota-tujuan" class="w-full">
                            {{-- <option value="Jakarta" harga="2000" @selected(old('kota-tujuan') == "Jakarta")>Jakarta</option>
                            <option value="Magelang" harga="1500" @selected(old('kota-tujuan') == "Magelang")>Magelang</option> --}}
                            <option></option>
                            @foreach ($kotas as $kota)
                                <option value="{{ $kota->kota }}" harga="{{ $kota->harga }}" @selected(old('kota-tujuan') == $kota->kota)>{{ $kota->kota }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="mb-6">
                    <div class="flex gap-3">
                        <div class="w-full">
                            ...
                            <input type="number" name="berat" id="berat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required value="{{ old('berat') }}">
                        </div>
                        <div class="w-full">
                            <label for="harga-kg" class="block mb-2 text-sm font-medium text-gray-900">Harga/Kg</label>
                            <input type="number" name="harga/kg" id="harga-kg" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required value="{{ old('harga/kg') }}">
                        </div>
                    </div>
                </div>
                <div class="mb-6">
                    <label for="keterangan-barang" class="block mb-2 text-sm font-medium text-gray-900">Keterangan Barang</label>
                    <input type="text" name="keterangan-barang" id="keterangan-barang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" min="1" required value="{{ old('keterangan-barang') }}">
                </div>
                <div class="flex justify-between gap-4 mb-10">
                    <div class="w-full">
                        <label for="koli" class="block mb-2 text-sm font-medium text-gray-900">Koli</label>
                        <input type="number" name="koli" id="koli" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" min="1" required value="{{ old('koli') ?? 1 }}">
                    </div>
                    <div class="w-full">
                        ...
                        <select name="pemeriksaan" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            <option value="0" @selected(old('pemeriksaan') == 0)>Tidak</option>
                            <option value="1" @selected(old('pemeriksaan') == 1)>Iya</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="">
                <div class="mb-6">
                    ...
                    <input type="text" name="nama-pengirim" id="nama-pengirim" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required value="{{ old('nama-pengirim') }}">
                </div>
                <div class="mb-6">
                    <label for="kontak-pengirim" class="block mb-2 text-sm font-medium text-gray-900">Kontak Pengirim</label>
                    <input type="number" name="kontak-pengirim" id="kontak-pengirim" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="+62" required value="{{ old('kontak-pengirim') }}">
                </div>
                <div class="mb-6">
                    <label for="nama-penerima" class="block mb-2 text-sm font-medium text-gray-900">Nama Penerima</label>
                    <input type="text" name="nama-penerima" id="nama-penerima" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required value="{{ old('nama-penerima') }}">
                </div>
                <div class="mb-6">
                    <label for="kontak-penerima" class="block mb-2 text-sm font-medium text-gray-900">Kontak Penerima</label>
                    <input type="number" name="kontak-penerima" id="kontak-penerima" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="+62" required value="{{ old('kontak-penerima') }}">
                </div>
                <div class="mb-10">
                    <label for="alamat-penerima" class="block mb-2 text-sm font-medium text-gray-900">Alamat Penerima</label>
                    <textarea name="alamat-penerima" id="alamat-penerima" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Alamat lengkap...">{{ old('alamat-penerima') }}</textarea>
                </div>
            </div>
            <div class="">
                <div class="mb-6">
