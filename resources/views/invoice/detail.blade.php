    ...
    <div class="p-4 border border-gray-200 rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div class="">
                ...
                <div class="flex justify-end">
                    <a href="#" target="_blank" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 mr-2 mb-2" title="Print Invoice">
